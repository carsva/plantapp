...
class AddPlant extends Component {
  ...
  error = () => {
    if (this.state.error === true) {
      return <Message error header="Please fill all fields" />;
    }
  };
